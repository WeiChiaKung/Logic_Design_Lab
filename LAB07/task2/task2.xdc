...
set_property PACKAGE_PIN U17 [get_ports {volume_minus}]
set_property IOSTANDARD LVCMOS33 [get_ports {volume_minus}]
set_property PACKAGE_PIN T18 [get_ports {volume_plus}]
set_property IOSTANDARD LVCMOS33 [get_ports {volume_plus}]
