...
# push button input
set_property PACKAGE_PIN W19 [get_ports {in3}]
set_property IOSTANDARD LVCMOS33 [get_ports {in3}]
set_property PACKAGE_PIN T17 [get_ports {in2}]
set_property IOSTANDARD LVCMOS33 [get_ports {in2}]
set_property PACKAGE_PIN U17 [get_ports {in}]
set_property IOSTANDARD LVCMOS33 [get_ports {in}]
set_property PACKAGE_PIN T18 [get_ports {in1}]
set_property IOSTANDARD LVCMOS33 [get_ports {in1}]

set_property PACKAGE_PIN V17 [get_ports {set_mode}]
